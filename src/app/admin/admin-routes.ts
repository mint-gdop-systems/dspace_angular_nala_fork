...
import { ThemedAdminWorkflowPageWrapperComponent } from './admin-workflow-page/themed-admin-workflow-page-wrapper.component';
...
export const ROUTES: Route[] = [
  ...
  },
  {
    path: 'workflow',
    resolve: { breadcrumb: i18nBreadcrumbResolver },
    component: ThemedAdminWorkflowPageWrapperComponent,
